# User Authentication. So far we’ve only created applications that assume everyone will see the same
# page. Now only those users will see website who are authenticated.
# For this used built-in tools such as
